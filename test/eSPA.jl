...
@testset "extras" begin
    ...
    @testset "mi_continuous_discrete function tests" begin
        ...
        @testset "step threshold MI" begin
            ...
            mi_est = mi_continuous_discrete(X, y_int, n_neighbors=3, rng=Random.MersenneTwister(42))
        ...
        @testset "uniform four level MI" begin
            ...
            mi_est = mi_continuous_discrete(X, y, n_neighbors=3, rng=Random.MersenneTwister(123))
        ...
        @testset "independent zero MI" begin
            ...
            mi_est = mi_continuous_discrete(X, y, n_neighbors=3, rng=Random.MersenneTwister(2024))
        ...
        @testset "constant label MI" begin
            ...
            mi_est = mi_continuous_discrete(X, y, n_neighbors=3, rng=Random.MersenneTwister(7))
    ...
    @testset "mi_continuous_discrete edge case tests" begin
        ...
        @testset "multiple features MI" begin
            ...
            mi_multi = mi_continuous_discrete(X_multi, y_multi, n_neighbors=3, rng=Random.MersenneTwister(1))
        ...
        @testset "perfect separability MI" begin
            ...
            mi_perfect = mi_continuous_discrete(X_perfect, y_perfect, n_neighbors=3, rng=Random.MersenneTwister(77))
        ...
        @testset "three classes discrete MI" begin
            ...
            mi_three = mi_continuous_discrete(X_three, y_three, n_neighbors=3, rng=Random.MersenneTwister(42))
        ...
        @testset "different n_neighbors discrete MI" begin
            ...
            mi_k1 = mi_continuous_discrete(X, y_int, n_neighbors=1, rng=Random.MersenneTwister(1))
            mi_k3 = mi_continuous_discrete(X, y_int, n_neighbors=3, rng=Random.MersenneTwister(1))
            mi_k5 = mi_continuous_discrete(X, y_int, n_neighbors=5, rng=Random.MersenneTwister(1))
        ...
        @testset "empty matrix MI" begin
            ...
            try
                mi_empty = mi_continuous_discrete(X_empty, y_empty, n_neighbors=3, rng=Random.MersenneTwister(42))
        ...
        @testset "single sample discrete MI" begin
            ...
            mi_single = mi_continuous_discrete(X_single, y_single, n_neighbors=3, rng=Random.MersenneTwister(42))
